...
#[Title('Create Work Check')]
class WorkCheckCreate extends Component
{
    public $staff_id;
    public $check_date;
    public $document_id;
    ...
    public function save()
    {
        ...
        $this->checkForExpiryNotification($workCheck);

        $this->dispatch('success', message: 'Work check created successfully.');
    ...
    public function render()
    {
        ...
        return view('work-check.work-check-create', [
            'staff' => $staff,
            'documents' => $documents,
        ]);
    }
